...
module.exports = {
  ...
  siteMetadata: {
    title: `Rathnavel karthi`,
    author: `Rathnavel karthi`,
    firstName: `Rathnavel`,
    lastName: `karthi`,
    description: `Rathnavel's personal site`,
    occupation: `Software Engineer & Cybersecurity`,
    keywords: [`Rathnavel`, `karthi`, `Personal`, `Blog`, `Resume`, `Projects`, `Work`],
    siteUrl:
